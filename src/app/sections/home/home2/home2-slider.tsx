 ...
 * @returns Content slider markup template for home 2
 */
const SectionHome2Slider = (
    props: {
    ...
    const { _slider } = props;
    return (
        <div className="av-bnr-2-wrap-outer home-2-slider swi-dotts">
            {/* swiper slides */}
                                ...
                                <div className="container">
                                    <div className="av-bnr-2-content">
                                        ...
                                        <div className="av-bnr-readmore">
                                            ...
                                            <NavLink to={navUrl.pages(route.pages.ABOUT)} className="site-button outline-white">
                                                Contact Us
                                                <i className="fa fa-plus" />
                                            </NavLink>
                                        </div>
...
export default SectionHome2Slider;