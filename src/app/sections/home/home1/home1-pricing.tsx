/**
 * @module Section-Home1-Pricing-Plans
 */
...
const SectionHome1Pricing = (
    ...
    return (
        <>
            <div className="section-full p-t120 p-b90 site-bg-white av-pricing-section-wrap wow fadeInDown" data-wow-offset={100} data-wow-delay="0.2">
                <div className="container">
                    ...
                    <div className="section-content">
                        <div className="owl-carousel av-price-carousel m-b30">
                            {
...
export default SectionHome1Pricing;