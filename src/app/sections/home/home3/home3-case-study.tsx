/**
 * @module Section-Home3-Case-Study
 */
...
const SectionHome3CaseStudy = (
    ...
    return (
        <div className="section-full p-t120 p-b90 site-bg-gray av-case3-section-wrap wow fadeInDown" data-wow-offset={100} data-wow-delay="0.2">
...
export default SectionHome3CaseStudy;